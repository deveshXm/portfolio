...
function Contact({ scroll }) {
  return (
    ...
    >
      ...
      <div className="w-fit flex justify-center mt-20 space-x-10">
        <div className="box p-10 w-fit text-4xl flex-1">
        ...
        <div className="flex-col flex-1 box p-10 flex items-center justify-center">
          <Button
            text={"Linkedin"}

...
const Expertise = ({ scroll }) => {
  ...
  return (
    <div
      ref={scroll}
      className="flex bg-[url('/images/expertise-bg.jpg')] min-h-screen bg-cover bg-no-repeat h-fit items-center justify-center z-10"
    >
      <div className="text-white pt-10 sm:pt-32">
        <h1
          className="font-bold text-4xl sm:text-7xl text-center font-poppins text-lightblue "
          data-aos="fade-right"
        >
          <Heading title={"My Expertise"} />
        </h1>
        <div
          className="text-white pt-20 space-y-5 lg:space-y-0 lg:flex lg:space-x-2 "
          data-aos="fade-up"
        >
        ...
        <div
          className="sm:flex sm:items-center sm:justify-center opacity-25 font-roboto"
          data-aos="fade-up"
        >
